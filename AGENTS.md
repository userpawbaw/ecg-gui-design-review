...
- When significant CREATIVE work has 2–4 serious directions and the user needs concrete side-by-side visual drafts, follow `docs/uiux_system/14_SUPERDESIGN_GENERATION_LAYER.md`. Use Superdesign only as a **generator** between art-direction/reference work and the validator pass.
