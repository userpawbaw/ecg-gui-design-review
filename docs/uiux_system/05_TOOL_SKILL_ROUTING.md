...
## 1. 현재 확인된 기본 상태 (2026-09-16 review)
...
### 공개 후보 / 필요 시 연결
- Mobbin — 상용 UI/UX 레퍼런스 연구; 비용/플랜 제약 확인 후 사용
...
| Attract/Intro | 01 Creative, 03 Motion, docs/13 | art-director, Product Design, Figma |
| Replay↔Live transition | 03 Motion, 04 Validation | motion-review, Context7, Playwright |
| 데이터 관계/스토리 | 02 Data, 04 Validation | Flourish, Product Design |
...
| 상용 레퍼런스 | 01 Creative | Mobbin 또는 웹 연구; 단순 모방 금지 |
